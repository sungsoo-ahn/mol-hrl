...
class MLPDecoder(torch.nn.Module):
    def __init__(self, num_layers, hidden_dim, code_dim):
        ...
        self.edge_projector1 = torch.nn.Linear(code_dim*2, code_dim * 2)
        self.edge_projector2 = torch.nn.Linear(code_dim*2, code_dim * 2)
        
        self.edge_projector3 = torch.nn.Linear(code_dim*2, code_dim * 2)
        self.edge_projector4 = torch.nn.Linear(code_dim*2, code_dim * 2)
        self.edge_projector5 = torch.nn.Linear(code_dim*2, num_bond_type + 1)
    ...
    def forward(self, h, batch):
        ...
        h_edge = self.edge_projector1(h_adjs)
        h_edge = F.relu(h_edge)
        h_edge = self.edge_projector2(h_edge)
        h_edge = F.relu(h_edge)
        h_edge = self.edge_projector3(h_edge)
        h_edge = F.relu(h_edge)
        h_edge = self.edge_projector4(h_edge)
        h_edge = F.relu(h_edge)
        h_edge = self.edge_projector5(h_edge)
        #print(h_edge)
