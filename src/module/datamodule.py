...
class Seq2SeqDataModule(BaseDataModule):
    def __init__(self, hparams):
        super(Seq2SeqDataModule, self).__init__(hparams)
...
class Seqs2SeqDataModule(BaseDataModule):
    def __init__(self, hparams):
        super(Seqs2SeqDataModule, self).__init__(hparams)
...
class Graph2SeqDataModule(BaseDataModule):
    def __init__(self, hparams):
        super(Graph2SeqDataModule, self).__init__(hparams)
...
class Graphs2SeqDataModule(BaseDataModule):
    def __init__(self, hparams):
        super(Graphs2SeqDataModule, self).__init__(hparams)
