...
from model.generator import EducatedGoalBasedGenerator
...
if __name__ == "__main__":
    ...
    EducatedGoalBasedGenerator.add_args(parser)
    PairedSmilesDataset.add_args(parser)
    Logger.add_args(parser)
    args = parser.parse_args()

    dataset = PairedSmilesDataset(
        args.data_dir, 
        args.data_tag, 
        args.data_aug_randomize_smiles, 
        args.data_aug_mutate
        )
    model = EducatedGoalBasedGenerator(
        args.generator_hidden_dim, 
        args.generator_goal_dim, 
